      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardDismissMode="on-drag">
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            {isRegistering ? 'Join the community to report issues.' : 'Sign in to continue reporting.'}
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  primaryBtn: { marginTop: 32, backgroundColor: '#111', borderRadius: 12, paddingVertical: 16, alignItems: 'center' },
